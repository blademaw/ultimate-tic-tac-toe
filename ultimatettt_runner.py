...
if __name__ == '__main__':
    ...
    ultimateMCTS = mcts(timeLimit = 2000)
    action = ultimateMCTS.search(initialState=state_2_prime)

    # state_2_move_2 = Action(2, 6, 1, 0)
    # print(f"Executing action: {str(state_2_move_2)}\n")
    print(f"MCTS believes action {str(action)} is the best. I think it's (2, 6, 1, 1).")
